...
class Building:
    ...
    def corners(self):
        _corner_S_W = [self.south, self.west]
        _corner_S_E = [self.south, self.west+self.width_WE]
        _corner_N_W = [self.south+self.width_NS, self.west]
        _corner_N_E = [self.south+self.width_NS, self.west+self.width_WE]
        _coners = {'north-east':_corner_N_E, 'south-east':_corner_S_E,
                   'south-west':_corner_S_W, 'north-west':_corner_N_W}
        return _coners
